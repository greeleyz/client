module.exports = function (grunt) {
  ...
  grunt.registerTask('release', ['clean','html2js','uglify','jshint','karma:unit','concat', 'recess:min','copy:assets']);
  ...
  grunt.initConfig({
    ...
    karma: {
        unit: { configFile: 'test/config/unitconfig.js' },
        watch: { configFile: 'test/config/unitconfig.js', singleRun: false, autoWatch: true}
    },
    html2js: {
      app: {
        options: {
